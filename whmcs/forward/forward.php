...
HTML;
    ...
    echo '<div class="form-group"><input type="hidden" name="quic" value="0"><label class="checkbox-inline"><input type="checkbox" name="quic" id="forward_admin_site_quic" value="1"> HTTP/3 (UDP 443)</label></div>';
