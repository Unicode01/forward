(function () {
  ...
  app.translations = {
    'zh-CN': {
      ...
      'site.form.desc': '多个域名共享 TCP 80/443；可选 HTTP/3 使用 UDP 443。',
      'site.form.domain': '域名',
      ...
      'validation.siteQUICRequiresHTTPS': '启用 HTTP/3 (UDP 443) 时必须填写 HTTPS 后端端口。',
    ...
    'en-US': {
      ...
      'site.form.desc': 'Share TCP ports 80/443 across domains, with optional HTTP/3 on UDP 443.',
