(function () {
  ...
  app.translations = {
    'zh-CN': {
      ...
      'wan.form.title.add': '添加 WAN 配置',
      'wan.form.title.edit': '编辑 WAN 配置 #{{id}}',
      'wan.form.desc': '用系统工具管理 WAN 控制面配置。Egress NAT 和托管网络仍然使用解析后的运行时接口接入现有 TC/XDP 路径。',
      'wan.form.name': '名称',
      'wan.form.name.placeholder': '例如：wan',
      'wan.form.type': '类型',
      'wan.form.reference': 'WAN 配置',
      'wan.form.parentInterface': '父接口',
      'wan.form.runtimeInterface': '运行时接口',
      'wan.form.ipv4CIDR': '静态 IPv4 CIDR',
      'wan.form.ipv4CIDR.placeholder': '例如 198.51.100.2/24',
      'wan.form.ipv4Gateway': '静态 IPv4 网关',
      'wan.form.username': 'PPPoE 用户名',
      'wan.form.password': 'PPPoE 密码',
      'wan.form.password.placeholder': '留空表示不设置或保持现有密码',
      'wan.form.password.keep': '留空保持当前密码',
      'wan.form.mtu': 'MTU',
      'wan.form.mru': 'MRU',
      'wan.form.defaultRoute': '安装默认路由',
      'wan.form.metric': '路由 Metric',
      'wan.form.dnsMode': 'DNS 模式',
      'wan.form.dnsServers': 'DNS 服务器',
      'wan.form.dnsServers.placeholder': '例如 223.5.5.5, 1.1.1.1',
      'wan.form.platform': '平台',
      'wan.form.remark.placeholder': '可选，如：主上联',
      'wan.form.submit.add': '添加 WAN 配置',
      'wan.form.submit.edit': '保存修改',
      'wan.type.existing': '现有接口',
      'wan.type.dhcp': 'DHCP',
      'wan.type.static': '静态 IPv4',
      'wan.type.pppoe': 'PPPoE',
      'wan.dnsMode.auto': '自动',
      'wan.dnsMode.manual': '手动',
      'wan.dnsMode.ignore': '忽略对端 DNS',
      'wan.status.running': '运行中',
      'wan.status.up': '已拉起',
      'wan.status.error': '异常',
      'wan.status.unsupported': '不支持',
      'wan.status.unknown': '未知',
      'wan.list.title': 'WAN 配置列表',
      'wan.list.effectiveInterface': '运行时接口',
      'wan.list.addresses': '地址',
      'wan.list.defaultIPv4': 'IPv4 默认路由',
      'wan.list.defaultIPv6': 'IPv6 默认路由',
      'wan.list.empty': '暂无 WAN 配置',
      'wan.select.none': '不使用 WAN 配置',
      'wan.select.noneManagedNetwork': '使用上行接口',
      'wan.select.noneEgressNAT': '使用出接口',
      'wan.select.missing': 'WAN 配置 #{{id}} 不存在',
      'wan.action.apply': '应用到系统',
      'wan.action.apply.success': 'WAN 配置已应用。',
      'wan.action.reconnect': '重连',
      'wan.action.reconnect.success': 'WAN 已重连。',
      'wan.delete.confirm': '确认删除 WAN 配置 #{{id}} 吗？',
      ...
      'search.wans.placeholder': '搜索 WAN 配置、接口、地址...',
      ...
      'validation.numberRange': '数值必须在 {{min}} 到 {{max}} 之间。',
      ...
      'validation.wanProfileNotFound': 'WAN 配置不存在或已被删除。',
      'validation.wanProfileDisabled': 'WAN 配置已禁用。',
      'validation.wanProfileReferenced': '该 WAN 配置仍被出向 NAT 或托管网络引用，不能删除。',
      'validation.wanProfileRuntimeUnresolved': 'WAN 运行时接口无法解析。',
      'validation.wanProfileRuntimeMissing': 'WAN 运行时接口在当前主机上不存在。',
      'validation.wanProfileCreateIDOmit': '创建 WAN 配置时不能携带 ID。',
    ...
    'en-US': {
      ...
      'wan.form.title.add': 'Add WAN Profile',
      'wan.form.title.edit': 'Edit WAN Profile #{{id}}',
      'wan.form.desc': 'Manage WAN control-plane configuration with system tools. Egress NAT and managed networks still consume the resolved runtime interface through the existing TC/XDP path.',
      'wan.form.name': 'Name',
      'wan.form.name.placeholder': 'For example: wan',
      'wan.form.type': 'Type',
      'wan.form.reference': 'WAN Profile',
      'wan.form.parentInterface': 'Parent Interface',
      'wan.form.runtimeInterface': 'Runtime Interface',
      'wan.form.ipv4CIDR': 'Static IPv4 CIDR',
      'wan.form.ipv4CIDR.placeholder': 'For example 198.51.100.2/24',
      'wan.form.ipv4Gateway': 'Static IPv4 Gateway',
      'wan.form.username': 'PPPoE Username',
      'wan.form.password': 'PPPoE Password',
      'wan.form.password.placeholder': 'Leave empty to keep current password',
      'wan.form.password.keep': 'Leave empty to keep current password',
      'wan.form.mtu': 'MTU',
      'wan.form.mru': 'MRU',
      'wan.form.defaultRoute': 'Install Default Route',
      'wan.form.metric': 'Route Metric',
      'wan.form.dnsMode': 'DNS Mode',
      'wan.form.dnsServers': 'DNS Servers',
      'wan.form.dnsServers.placeholder': 'For example 223.5.5.5, 1.1.1.1',
      'wan.form.platform': 'Platform',
      'wan.form.remark.placeholder': 'Optional, e.g. primary uplink',
      'wan.form.submit.add': 'Add WAN Profile',
      'wan.form.submit.edit': 'Save Changes',
      'wan.type.existing': 'Existing Interface',
      'wan.type.dhcp': 'DHCP',
      'wan.type.static': 'Static IPv4',
      'wan.type.pppoe': 'PPPoE',
      'wan.dnsMode.auto': 'Auto',
      'wan.dnsMode.manual': 'Manual',
      'wan.dnsMode.ignore': 'Ignore Peer DNS',
      'wan.status.running': 'Running',
      'wan.status.up': 'Up',
      'wan.status.error': 'Error',
      'wan.status.unsupported': 'Unsupported',
      'wan.status.unknown': 'Unknown',
      'wan.list.title': 'WAN Profiles',
      'wan.list.effectiveInterface': 'Runtime Interface',
      'wan.list.addresses': 'Addresses',
      'wan.list.defaultIPv4': 'IPv4 default route',
      'wan.list.defaultIPv6': 'IPv6 default route',
      'wan.list.empty': 'No WAN profiles yet.',
      'wan.select.none': 'No WAN profile',
      'wan.select.noneManagedNetwork': 'Use uplink interface',
      'wan.select.noneEgressNAT': 'Use outbound interface',
      'wan.select.missing': 'WAN profile #{{id}} missing',
      'wan.action.apply': 'Apply',
      'wan.action.apply.success': 'WAN profile applied.',
      'wan.action.reconnect': 'Reconnect',
      'wan.action.reconnect.success': 'WAN reconnected.',
      'wan.delete.confirm': 'Delete WAN profile #{{id}}?',
      ...
      'search.wans.placeholder': 'Search WAN profiles, interfaces, addresses...',
      ...
      'empty.action.wan': 'Create First WAN Profile',
      ...
      'validation.numberRange': 'Value must be between {{min}} and {{max}}.',
      ...
      'validation.wanProfileNotFound': 'The WAN profile no longer exists.',
      'validation.wanProfileDisabled': 'The WAN profile is disabled.',
      'validation.wanProfileReferenced': 'The WAN profile is still referenced by Egress NAT or managed networks.',
      'validation.wanProfileRuntimeUnresolved': 'The WAN runtime interface cannot be resolved.',
      'validation.wanProfileRuntimeMissing': 'The WAN runtime interface does not exist on this host.',
      'validation.wanProfileCreateIDOmit': 'Do not send an ID when creating a WAN profile.',
