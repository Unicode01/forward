...
var Schema = map[string][][2]string{
	...
	"egress_nats": {
		...
		{"out_interface", "TEXT NOT NULL DEFAULT ''"},
		{"wan_profile_id", "INTEGER NOT NULL DEFAULT 0"},
		{"out_source_ip", "TEXT NOT NULL DEFAULT ''"},
	...
	"wan_profiles": {
		...
		{"parent_interface", "TEXT NOT NULL DEFAULT ''"},
		{"runtime_interface", "TEXT NOT NULL DEFAULT ''"},
		...
		{"default_route", "INTEGER NOT NULL DEFAULT 1"},
		{"metric", "INTEGER NOT NULL DEFAULT 0"},
		{"dns_mode", "TEXT NOT NULL DEFAULT 'auto'"},
...
var SchemaIndexes = []IndexDefinition{
	...
	{Name: "idx_egress_nats_wan_profile", Table: "egress_nats", Columns: "wan_profile_id, enabled"},
	{Name: "idx_wan_profiles_enabled", Table: "wan_profiles", Columns: "enabled"},
	{Name: "idx_wan_profiles_name", Table: "wan_profiles", Columns: "name"},
	{Name: "idx_wan_profiles_type", Table: "wan_profiles", Columns: "type"},
